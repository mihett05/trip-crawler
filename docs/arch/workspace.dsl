    ...
    model {
        ...
        s = softwareSystem "Наш сервис" {
            ...
            mainService = service "Main Service" "Основной сервис" {
                ...
                routeBuilder = component "RouteBuilder" "Реализация алгоритма построения маршрута"
                schedulerQueueAdapter = component "SchedulerQueueAdapter" "Адаптер над очередью планировщика"

                routeBuilderService = component "RouteBuilderService" "Сервис для построения маршрутов"
                ...
                routeBuilderService -> graphRepository
                ...
                routeHttpHandler = component "RouteHandler" "Хендлеры для работы с маршрутами"
                ...
                routeHttpHandler -> routeBuilderService
            ...
            mainService.routeBuilder -> graphDbms
